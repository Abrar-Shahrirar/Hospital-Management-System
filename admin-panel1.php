...
<html lang="en">
  ...
  <style >
    .bg-primary {
    background: -webkit-linear-gradient(left, #185b85, #31697d);
}
...
.btn-primary{
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 45%; padding-bottom: 40px;font-family: 'IBM Plex Sans', sans-serif;"> Welcome Admin </h3>
    <div class="row">
  <div class="col-md-4" style="max-width:18%;margin-top: 4%;">
