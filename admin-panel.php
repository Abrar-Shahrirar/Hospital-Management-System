...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> Swsen Health Care Hospital</h2></br>
  ...
  ob_end_clean();
  $obj_pdf -> Output("H.M.S_bill.pdf",'I');
...
<html lang="en">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css?family=IBM+Plex+Sans&display=swap" rel="stylesheet">
      ...
      <a class="navbar-brand" href="#"style= "margin-top: 0px; margin-right: 1100px; font-family: 'IBM Plex Sans', sans-serif; "><h5 style="color: white;"><i class="fa fa-user-plus" aria-hidden="true"></i> <b>Swsen Health Care Hospital</b> </h5></a>
  ...
  <style >
    .bg-primary {
    background: -webkit-linear-gradient(left, #377e8c, #086b8a);
}
...
.btn-primary{
  ...
  border-color: #09c5eb;
        ...
        <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active" style="margin-right: 40px; font-family: 'IBM Plex Sans', sans-serif;"><a href="contact.html" style="color: white">Contact</a></li>
            <li class="active" style="margin-right: 40px; font-family: 'IBM Plex Sans', sans-serif;"><a href="logout.php" style="color: white">Logout</a></li>
              </ul>
        </div>
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 41%;  padding-bottom: 40px; font-family: 'IBM Plex Sans', sans-serif;"> Welcome &nbsp<?php echo $username ?> </h3>
    <div class="row">
  <div class="col-md-4" style="max-width:18%; margin-top: 9%">
    ...
    <div class="tab-content" id="nav-tabContent" style="width: 950px;">
      ...
      <div class="tab-pane fade  show active" id="list-dash" role="tabpanel" aria-labelledby="list-dash-list">
        <div class="container-fluid container-fullw bg-white" >
              <div class="row">
               <div class="col-sm-4" style="left: 25%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-terminal fa-stack-1x fa-inverse"></i> </span>
                      <h4 class="StepTitle" style="margin-top: 45%;"> Book My Appointment</h4>
                      <script>
                ...
                <div class="col-sm-4" style="left: 25%; ">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      ...
                      <h4 class="StepTitle" style="margin-top: 45%;">My Appointments</h2>
                ...
                <div class="col-sm-4" style="left: 41%; margin-top:5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
