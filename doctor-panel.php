...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> Swsen Health Care Hospital </a>
  ...
  <style >
    .bg-primary {
    background: -webkit-linear-gradient(left, #23657d, #0884cc);
}
body{
...
<div class="collapse navbar-collapse navbar-right navbar-main-collapse">
     <ul class="navbar-nav">
     <li class="active" style="margin-right: 40px; font-family: 'IBM Plex Sans', sans-serif;"><a href="logout1.php" style="color: white">Logout</a></li>
     </ul>
</div>
    ...
    <form class="form-inline my-2 my-lg-7" method="post" action="search.php">
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 41%; padding-bottom: 40px; font-family:'IBM Plex Sans', sans-serif;"> Welcome Dr.&nbsp<?php echo $_SESSION['dname'] ?>! </h3>
    <div class="row">
  ...
  <div class="col-md-8" style="margin-top: 3%;">
    <div class="tab-content" id="nav-tabContent" style="width: 950px;">
      <div class="tab-pane fade show active" id="list-dash" role="tabpanel" aria-labelledby="list-dash-list">
              ...
              <div class="container-fluid container-fullw bg-none" >
              <div class="row">
               ...
               <div class="col-sm-4" style="left: 25%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <h4 class="StepTitle" style="margin-top: 45%;"> View Appointments</h4>
                      <script>
                ...
                <div class="col-sm-4" style="left: 25%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <h4 class="StepTitle" style="margin-top: 45%;"> Prescriptions</h4>
