...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
<a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 3%; margin-left: -25%; font-family: 'IBM Plex Sans', sans-serif;"><i class="fa fa-user-plus" aria-hidden="true"></i><h3><b>Swsen Health Care Hospital</b></h3></a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item" style="margin-right: 30px;margin-top: 7%;">
          ...
          <li class="nav-item"style="margin-right: -20px;margin-top: 7%;">
  ...
  <div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-8 register-left" style="margin-top: -3%;right: 35%;">
                        <img src="images/project logo.png" alt=""/>
                        <h3><b>Welcome To </b></h3>
                        <span><h2><b>Swsen Health Care Hospital</b></h2></span>
                        <span><h3><b>Stay safe, Stay healthy</b></h3></span>
                        <span><h5><b>SWSEN EMERGENCY CARE</b></h5></span>
                        <span><b>IN YOUR TIME OF EMERGENCY TRUST IN OUR EXPERTISE</b></span><br />
                        <span><b>Call 0627 (Available24/7)</b></span>
                    </div>       


                    <div class="col-md-9 register-right" style="margin-top: -400px;left: 340px;">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <h3 class="register-heading">Patient Portal</h3>
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="tel" minlength="11" maxlength="11" name="contact" class="form-control" placeholder="Your Phone *"  />
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="tab-pane fade show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                <h3  class="register-heading">Doctor Portal</h3>
                            ...
                            <div class="tab-pane fade show" id="admin" role="tabpanel" aria-labelledby="profile-tab">
                                <h3  class="register-heading">Admin Portal</h3>
